...
from todo.views import ProjetoViewSet, QuadroViewSet, ListaViewSet, CartaoViewSet, EtiquetaViewSet, AtividadeViewSet, ListaMembrosViewSet, IndexTemplateView, PainelDetailView
